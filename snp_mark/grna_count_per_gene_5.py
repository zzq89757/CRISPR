...
for nc_no in nc_li:
    ...
    gdb_df = tsv2df(f"/mnt/ntc_data/wayne/Repositories/CRISPR/snp_mark/{nc_no}.tsv",type_li)

    for gene, sub_df in gdb_df.groupby(8):
        # raw sub df
        ...
        # filter sub df
        filtered_sub_df = sub_df[(sub_df[18]>=0.5)&(sub_df[22]>=0.5)]
        # counter filter
