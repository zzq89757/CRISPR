...
path.append("/mnt/ntc_data/wayne/Repositories/CRISPR/utils/")
from read_tsv import tsv2df
...
def flashfry_cmd(gdb_fa_path: str, ot_path: str, output_path: str) -> None:
    # print(f"java -Xmx8g -jar /mnt/ntc_data/wayne/Repositories/CRISPR/score/CFD_Scoring/test/FlashFry-assembly-1.15.jar  discover  --database {ot_path}  --fasta {gdb_fa_path}  --output {output_path} --maxMismatch 3 --maximumOffTargets 100")
    system(f"java -Xmx8g -jar /mnt/ntc_data/wayne/Repositories/CRISPR/score/CFD_Scoring/test/FlashFry-assembly-1.15.jar  discover  --database {ot_path}  --fasta {gdb_fa_path}  --output {output_path} --maxMismatch 3 --maximumOffTargets 100")
