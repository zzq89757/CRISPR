...
awk '$3=="gene"&&($0~/ncRNA/||$0~/misc_RNA/||$0~/protein_coding/){print $NF}' GCF_000001405.40/genomic.gtf|wc -l 

awk '$3=="gene"&&$0~/protein_coding/&&$0~/^NC_/{print $1"\t"$4"\t"$5"\t"$7"\t"$10}' *gtf > coding.tsv